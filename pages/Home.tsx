    ...
    <div className="space-y-20 pb-20">
      ...
      <section className="relative h-[80vh] flex items-center bg-gray-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-white z-10">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-2xl text-gray-300">Discover the latest trends in clothing for kids, teens, and adults. Affordable, stylish, and made for you.</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="rounded-3xl overflow-hidden shadow-xl">
             <img src="https://picsum.photos/seed/about/800/600" alt="Team" className="w-full" />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white py-20 border-y">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <FeatureCard 
              title="Wide Variety" 
              desc="Thousands of styles across Men, Women, and Kids categories."
              icon="🛍️"
            />
            <FeatureCard 
              title="Best Prices" 
